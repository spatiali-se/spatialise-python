...
async def test_basic(sync: bool, client: SpatialiseSoilPrediction, async_client: AsyncSpatialiseSoilPrediction) -> None:
...
async def test_data_missing_event(
    sync: bool, client: SpatialiseSoilPrediction, async_client: AsyncSpatialiseSoilPrediction
) -> None:
    def body() -> Iterator[bytes]:
        yield b'data: {"foo":true}\n'
        yield b"\n"
