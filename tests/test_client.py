...
from spatialise._exceptions import (
    APIStatusError,
    APITimeoutError,
    APIResponseValidationError,
    SpatialiseSoilPredictionError,
)
...
def _get_open_connections(client: SpatialiseSoilPrediction | AsyncSpatialiseSoilPrediction) -> int:
...
class TestSpatialiseSoilPrediction:
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response(self, respx_mock: MockRouter, client: SpatialiseSoilPrediction) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: SpatialiseSoilPrediction) -> None:
    ...
    def test_copy(self, client: SpatialiseSoilPrediction) -> None:
        copied = client.copy()
    ...
    def test_copy_default_options(self, client: SpatialiseSoilPrediction) -> None:
    ...
    def test_copy_signature(self, client: SpatialiseSoilPrediction) -> None:
    ...
    def test_copy_build_request(self, client: SpatialiseSoilPrediction) -> None:
    ...
    def test_request_timeout(self, client: SpatialiseSoilPrediction) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_default_headers_option(self) -> None:
        test_client = SpatialiseSoilPrediction(
            base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        ...
        test_client2 = SpatialiseSoilPrediction(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_validate_headers(self) -> None:
        client = SpatialiseSoilPrediction(base_url=base_url, api_key=api_key, _strict_response_validation=True)
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("Authorization") == f"Bearer {api_key}"

        with pytest.raises(SpatialiseSoilPredictionError):
    ...
    def test_request_extra_json(self, client: SpatialiseSoilPrediction) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: SpatialiseSoilPrediction) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: SpatialiseSoilPrediction) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: SpatialiseSoilPrediction) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: SpatialiseSoilPrediction) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: SpatialiseSoilPrediction) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_idempotency_header_options(self, respx_mock: MockRouter, client: SpatialiseSoilPrediction) -> None:
    ...
    def test_base_url_trailing_slash(self, client: SpatialiseSoilPrediction) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: SpatialiseSoilPrediction) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: SpatialiseSoilPrediction) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = SpatialiseSoilPrediction(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: SpatialiseSoilPrediction) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = SpatialiseSoilPrediction(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        non_strict_client = SpatialiseSoilPrediction(
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: SpatialiseSoilPrediction
    ) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: SpatialiseSoilPrediction) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: SpatialiseSoilPrediction) -> None:
...
class TestAsyncSpatialiseSoilPrediction:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncSpatialiseSoilPrediction) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    def test_copy(self, async_client: AsyncSpatialiseSoilPrediction) -> None:
    ...
    def test_copy_default_options(self, async_client: AsyncSpatialiseSoilPrediction) -> None:
        # options that have a default are overridden correctly
    ...
    def test_copy_signature(self, async_client: AsyncSpatialiseSoilPrediction) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncSpatialiseSoilPrediction) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncSpatialiseSoilPrediction) -> None:
    ...
    async def test_default_headers_option(self) -> None:
        test_client = AsyncSpatialiseSoilPrediction(
            base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        request = test_client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("x-foo") == "bar"
        ...
        test_client2 = AsyncSpatialiseSoilPrediction(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_validate_headers(self) -> None:
        client = AsyncSpatialiseSoilPrediction(base_url=base_url, api_key=api_key, _strict_response_validation=True)
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("Authorization") == f"Bearer {api_key}"

        with pytest.raises(SpatialiseSoilPredictionError):
            with update_env(**{"SPATIALISE_API_KEY": Omit()}):
                client2 = AsyncSpatialiseSoilPrediction(
    ...
    def test_multipart_repeating_array(self, async_client: AsyncSpatialiseSoilPrediction) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_idempotency_header_options(
        self, respx_mock: MockRouter, async_client: AsyncSpatialiseSoilPrediction
    ) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={}))
    ...
    async def test_base_url_trailing_slash(self, client: AsyncSpatialiseSoilPrediction) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncSpatialiseSoilPrediction) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncSpatialiseSoilPrediction) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncSpatialiseSoilPrediction(
            base_url=base_url, api_key=api_key, _strict_response_validation=True
        )
        ...
        non_strict_client = AsyncSpatialiseSoilPrediction(
            base_url=base_url, api_key=api_key, _strict_response_validation=False
        )
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncSpatialiseSoilPrediction
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncSpatialiseSoilPrediction,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncSpatialiseSoilPrediction, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncSpatialiseSoilPrediction) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
